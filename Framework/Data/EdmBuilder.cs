    ...
    public static class EdmBuilder
    {
        ...
        private static IEdmModel GetCodeFirstEdm<T>(this T dbContext) where T : DbContext
        {
            using (var stream = new MemoryStream())
            {
                ...
                //AddReadonlyProperty(edmx, "Project", "OtherUsersResourcePoolRateTotal", "Decimal", true);
                //AddReadonlyProperty(edmx, "Project", "OtherUsersResourcePoolRateCount", "Int32", false);
